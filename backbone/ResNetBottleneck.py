...
def resnet50(num_classes: int, pretrained=False, cifar=False, **kwargs: Any) -> ResNet:
    ...
    """
    return ResNet(Bottleneck, [3, 4, 6, 3], num_classes=num_classes, pretrained=pretrained, cifar=cifar, **kwargs)


def resnet101(num_classes: int, pretrained=False, cifar=False, **kwargs: Any) -> ResNet:
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return ResNet(Bottleneck, [3, 4, 23, 3], num_classes=num_classes, pretrained=pretrained, cifar=cifar, **kwargs)
