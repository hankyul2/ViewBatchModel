...
def add_experiment_args(parser: ArgumentParser) -> None:
    ...
    exp_group.add_argument('--label_perc', type=float, default=1,
    ...
    validation_group = parser.add_argument_group('Validation and fitting arguments',
                                                 'Arguments used to define the validation strategy and the method used to fit the model.')

    validation_group.add_argument('--validation', type=float,
    ...
    validation_group.add_argument('--fitting_mode', type=str, choices=['epochs', 'iters', 'time', 'early_stopping'],
                                  default='epochs',
    ...
    opt_group = parser.add_argument_group('Optimizer and learning rate scheduler arguments',
...
def add_management_args(parser: ArgumentParser) -> None:
    ...
    Returns:
        None
    """
    mng_group = parser.add_argument_group('Management arguments',
                                          'Generic arguments to manage the experiment reproducibility, logging, debugging, etc.')

    mng_group.add_argument('--seed', type=int, default=1997,
    ...
    mng_group.add_argument('--num_workers', type=int, default=2,
    ...
    mng_group.add_argument('--debug_mode', type=int, default=0, choices=[0, 1],
    ...
    mng_group.add_argument('--distributed', type=str, default='no', choices=['no', 'dp', 'ddp'],
                           help='Enable distributed training?')
    mng_group.add_argument('--savecheck', default=0, choices=[0, 1], type=int, help='Save checkpoint?')
    mng_group.add_argument('--loadcheck', type=str, default=None,
    ...
    wandb_group.add_argument('--wandb_entity', type=str, default='results', help='Wandb entity')
    wandb_group.add_argument('--wandb_project', type=str, default='view_batch_model', help='Wandb project name')
    wandb_group.add_argument('--log_stdout', default=False, choices=[False, True], type=bool,
                             help='Log stdout to wandb?')
    wandb_group.add_argument('--log_stderr', default=False, choices=[False, True], type=bool,
                             help='Log stderr to wandb?')
