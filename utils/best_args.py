...
best_args = {
    ...
    'seq-tinyimg': {'sgd': {-1: {'lr': 0.03,
                    ...
                    'derpp': {200: {'lr': 0.04,
                                    'minibatch_size': 32,
                                    'alpha': 0.1,  # Distillation from Buffer
                                    'beta': 1.0,  # Replay Buffer Loss
                                    'batch_size': 32,
                                    'n_epochs': 100},
                              500: {'lr': 0.03,
                                    ...
                                    'alpha': 0.2,  # org: 0.2
                                    'beta': 0.5,
                                    'batch_size': 32,  # org: 32
                                    'n_epochs': 100},
                              5120: {'lr': 0.03,
                                     'minibatch_size': 32,
                                     'alpha': 0.1,
                                     'beta': 0.5,
                                     'batch_size': 32,  # maybe bigger batch size??
                                     'n_epochs': 100}}},
    'mnist-360': {
    ...
    'seq-cifar100': {
        ...
        'icarl': {
            ...
            2000: {'lr': 0.1, 'optim_mom': 0, 'optim_wd': 1e-05, 'n_epochs': 170, 'lr_scheduler': 'multisteplr', 'lr_milestones': [100, 120]}
        },
        'bic': {
    ...
    'seq-domainnet-128': {'sgd': {-1: {'lr': 0.1,
                                       'batch_size': 128,
                                       'n_epochs': 50}},
                          'slca': {-1: {'lr': 0.01,
                                        'batch_size': 128,
    ...
    'seq-imagenet': {
            ...
            'lwf': {-1: {'lr': 0.01,
                         ...
                         'optim_wd': 0.0005}},
           'icarl': {
                  2000: {'lr': 2.0, 'optim_mom': 0, 'optim_wd': 1e-05, 'n_epochs': 60, 'lr_scheduler': 'multisteplr', 'lr_milestones': [20, 30, 40, 50], 'sched_multistep_lr_gamma': 0.2},
           },
           'derpp': {
                  20000: {'lr': 0.03, 'optim_mom': 0, 'optim_wd': 0, 'alpha': 0.1, 'beta': 0.5, 'n_epochs': 60, 'lr_scheduler': 'multisteplr', 'lr_milestones': [20, 30, 40, 50]},
           }
      },
      'seq-five-datasets': {
            'sgd': {-1: {'lr': 0.1,
            ...
            'icarl': {
                  2000: {'lr': 0.1, 'optim_mom': 0, 'optim_wd': 1e-05, 'n_epochs': 50, 'lr_scheduler': 'multisteplr', 'lr_milestones': [20, 30, 40]},
            },
            'er' : {
                  2000: {'lr': 0.1, 'optim_mom': 0, 'optim_wd': 0, 'n_epochs': 50}
            }
                       
      },
      'seq_imbalanced_cifar100': {
            'sgd': {-1: {'lr': 0.1,
                         'batch_size': 128,
                         'n_epochs': 50}},
            'lwf': {-1: {'lr': 0.01,
