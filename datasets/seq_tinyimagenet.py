...
from backbone.ResNetBottleneck import resnet50, resnet101
...
class SequentialTinyImagenet(ContinualDataset):
    ...
    def get_backbone():
        ...
        # return resnet34(SequentialTinyImagenet.N_CLASSES_PER_TASK * SequentialTinyImagenet.N_TASKS)

        # return resnet50(SequentialTinyImagenet.N_CLASSES_PER_TASK * SequentialTinyImagenet.N_TASKS, cifar=True)

        # return resnet101(SequentialTinyImagenet.N_CLASSES_PER_TASK * SequentialTinyImagenet.N_TASKS, cifar=True)
